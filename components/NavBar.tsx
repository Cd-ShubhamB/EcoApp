...
import { Home, LogOut, ShoppingCart, Upload } from "lucide-react-native";
import { useState } from "react";
import { Modal, Pressable, Text, TouchableOpacity, View } from "react-native";
import { useAuth } from "../context/AuthContext";

type NavRoute = "/Dashboard" | "/ExcelOrder" | "/Checkout" | "/";
...
export default function NavBar() {
  ...
  const navItems: { route: NavRoute; icon: React.ElementType; label: string }[] = [
    ...
    { route: "/ExcelOrder", icon: Upload, label: "Upload" },
    { route: "/Checkout", icon: ShoppingCart, label: "Checkout" },
